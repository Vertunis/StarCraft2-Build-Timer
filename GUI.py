...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(792, 528)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.tabWidget = QtWidgets.QTabWidget(self.centralwidget)
        self.tabWidget.setGeometry(QtCore.QRect(0, 0, 781, 471))
        self.tabWidget.setObjectName("tabWidget")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.groupBox_4 = QtWidgets.QGroupBox(self.tab)
        self.groupBox_4.setGeometry(QtCore.QRect(420, 10, 341, 381))
        font = QtGui.QFont()
        ...
        self.listWidget_builds.setGeometry(QtCore.QRect(10, 70, 321, 301))
        ...
        self.groupBox_6.setGeometry(QtCore.QRect(10, 100, 401, 291))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(126, 92, 271, 71))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.textBrowser_object.setGeometry(QtCore.QRect(10, 20, 251, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.groupBox.setGeometry(QtCore.QRect(66, 92, 61, 71))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.textBrowser_probe_nr.setGeometry(QtCore.QRect(8, 20, 41, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(6, 92, 61, 71))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.textBrowser_timer.setGeometry(QtCore.QRect(4, 20, 51, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.tableView.setGeometry(QtCore.QRect(10, 170, 381, 111))
        self.tableView.setObjectName("tableView")
        self.label = QtWidgets.QLabel(self.tab)
        self.label.setGeometry(QtCore.QRect(20, 400, 411, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Objekt"))
